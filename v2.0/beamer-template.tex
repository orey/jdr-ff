...
\newcommand{\mytitle}{Fighting Fantasy, version française}
\newcommand{\myauthor}{Steve Jackson, Ian Livingstone, Olivier Rey}
\newcommand{\mysubject}{Jeu de rôles}
\newcommand{\mykeywords}{JDR,TTRPG,RPG,orey,fighting_fantasy,fighting,fantasy}
...
\newcommand{\myheader}{{\Huge F}{\huge IGHTING} {\Huge F}{\huge ANTASY}}
...
% caractéristiques
\title[Fighting Fantasy]{Fighting Fantasy - Règles complètes}
\author{Olivier Rey}
...
\vspace{0.4cm}
\begin{center}
\color{gray}{\tiny Fighting Fantasy -- Page \thepage}
\end{center}
\vspace{0.4cm}}
